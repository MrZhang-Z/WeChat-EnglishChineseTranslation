...
Page({
  ...
  translate:function(){
    ...
    var date = this.formatDate(new Date().getTime(), 'YYYY-MM-DD hh-mm-ss'); // 获取当前系统时间, 没有格式化
    ...
    wx.request({
      ...
      success: function (result) {
        // console.log(result.data.translateResult[0][0].tgt)
        _this.setData({
          to: result.data.translateResult[0][0].tgt
        })
      }
    })
